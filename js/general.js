document.addEventListener("DOMContentLoaded", function() {
  ...
  const strongHTMLs = [
    '<strong><i class="cp cp-beehive"></i></strong>',
    '<strong><i class="far fa-bullseye"></i></strong>',
    '<strong><i class="cp cp-helm-o"></i></strong>',
    '<strong><i class="cp cp-galactic-republic"></i></strong>',
    '<strong><i class="far fa-atom"></i></strong>',
    '<strong><i class="fas fa-tombstone-alt"></i></strong>'
  ];
