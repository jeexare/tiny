$(document).ready(function(){
    ...
    $(this).parents('.simpfield').addClass($(this).text().split(" ")[0].toLowerCase().replace(/'/g, "").replace(/\(|\)/g, ""));
    });
    });
    ...
    const month = new Date(Date.parse(monthString + ' 1, ' + year)).getMonth() + 1;
      
      // NIVEL
      var nivelField = document.querySelector('.nivel .simpcontent .field_uneditable');
      if (nivelField) {
      ...
      // INVENTARIO
    var invField = document.querySelector('.simpfield.inventario .simpcontent .field_uneditable');
      if (invField) {
    ...
    invContainer.innerHTML = invDecoded;
        ...
        // HABILIDADES
    var habField = document.querySelector('.simpfield.habilidades .simpcontent .field_uneditable');
      if (habField){
    ...
    habContainer.innerHTML = habDecoded;
      ...
      for (var i = 0; i < psStats.length; i++) {
        ...
        // PV
        if (i === 0) {
          var pvField = document.querySelector('.pv .simpcontent .field_uneditable');
    var pvContent = pvField.innerHTML;
        bElement.textContent = pvContent + ' pv';
        divElement.setAttribute('act', pvContent);
        divElement.setAttribute('max', 50);
        }
        
            // PP
        if (i === 1) {
          var ppField = document.querySelector('.pp .simpcontent .field_uneditable');
    var ppContent = ppField.innerHTML;
        ...
        divElement.setAttribute('max', 50);
                ...
                // ATQ
        if (i === 2) {
          var atqField = document.querySelector('.atq .simpcontent .field_uneditable');
    var atqContent = atqField.innerHTML;
        bElement.textContent = atqContent + ' atq';
        divElement.setAttribute('act', atqContent);
        divElement.setAttribute('max', 50);
        }
        
                    // DEF
        if (i === 3) {
          var defField = document.querySelector('.def .simpcontent .field_uneditable');
    var defContent = defField.innerHTML;
        bElement.textContent = defContent + ' def';
        ...
        divElement.setAttribute('max', 50);
                    ...
                    // SPATQ
        if (i === 4) {
          var spatqField = document.querySelector('.spatq .simpcontent .field_uneditable');
    var spatqContent = spatqField.innerHTML;
        bElement.textContent = spatqContent + ' sp atq';
        divElement.setAttribute('act', spatqContent);
        divElement.setAttribute('max', 50);
        }
        
                        // SPDEF
        if (i === 5) {
          var spdefField = document.querySelector('.spdef .simpcontent .field_uneditable');
    var spdefContent = spdefField.innerHTML;
        bElement.textContent = spdefContent + ' sp def';
        divElement.setAttribute('act', spdefContent);
        divElement.setAttribute('max', 50);
        }
        
                            // VEL
        if (i === 6) {
          var velField = document.querySelector('.vel .simpcontent .field_uneditable');
    var velContent = velField.innerHTML;
      ...
      // IMAGEN
      var imagenField = document.querySelector('.imagen .simpcontent .field_uneditable img');
      if (imagenField) {
    ...
    imagenContainer.setAttribute('src', imagenContent);
      ...
      for (var i = 0; i < psAsks.length; i++) {
        ...
        // MENSAJES
        if (i === 0) {
          var msjField = document.querySelector('.mensajes .simpcontent .field_uneditable');
        ...
        // PUNTOS
        if (i === 1) {
         var puntosField = document.querySelector('.puntos .simpcontent .field_uneditable');
          var puntosContent = puntosField.innerHTML;
          emElement.innerHTML = puntosContent;
          bElement.innerHTML = "Puntos";
        }
        // EXP
        if (i === 2) {
        var experienciaField = document.querySelector('.experiencia .simpcontent .field_uneditable');
        ...
        if (i === 3) {
        var fechaField = document.querySelector('.fecha .simpcontent .field_uneditable');
          ...
          bElement.innerHTML = "FECHA DE INSCRIPCIÓN";}
                ...
                // EDAD
        if (i === 4) {
        var edadField = document.querySelector('.edad .simpcontent .field_uneditable');
          ...
          bElement.innerHTML = "EDAD";
                   ...
                   // Face CLaim
        if (i === 5) {
        var fcField = document.querySelector('.face .simpcontent .field_uneditable');
          ...
          bElement.innerHTML = "Face Claim";
                    ...
                    // origen
        if (i === 6) {
        var origenField = document.querySelector('.origen .simpcontent .field_uneditable');
          ...
          bElement.innerHTML = "Origen";
                    ...
                    // nacionalidad
        if (i === 7) {
        var nacField = document.querySelector('.nacionalidad .simpcontent .field_uneditable');
          ...
          bElement.innerHTML = "Nacionalidad";
                    ...
                    // recolección
        if (i === 8) {
        var exField = document.querySelector('.recolección .simpcontent .field_uneditable');
      ...
      for (var i = 0; i < psLinks.length; i++) {
        ...
        if (i === 3) {
          ...
          psLink.textContent = "Mensaje Privado";
           ...
           // Ficha
        if (i === 4) {
          var fichaField = document.querySelector('.ficha .simpcontent .field_uneditable a');
          if (!fichaField){
            psLink.remove();
            continue;
          }
          ...
          psLink.textContent = "Ficha";
               ...
               // BAUL
        if (i === 5) {
          var baulField = document.querySelector('.baul .simpcontent .field_uneditable a');
          if (!baulField){
            psLink.remove();
            continue;
          }
